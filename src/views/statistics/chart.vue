<template>
  <div class="app-container">
    ...
    <el-row> <!-- Layout布局: 一行24 -->
      <el-col :span="12"><div id="register_num" class="chart" style="height:400px;" /></el-col>
      <el-col :span="12"><div id="login_num" class="chart" style="height:400px;" /></el-col>
    </el-row>
    <el-row>
      <el-col :span="12"><div id="video_view_num" class="chart" style="height:400px;" /></el-col>
      <el-col :span="12"><div id="course_num" class="chart" style="height:400px;" /></el-col>
    </el-row>
  </div>
</template>
  ...
  methods: {
    ...
    showChartByType(type, title, data) {
      ...
      var option = {
        ...
        tooltip: {}, // 鼠标悬停效果
        xAxis: {
          data: data.xList // 日期列表
        },
        yAxis: {},
        series: [{
          type: 'line', // 折线图
          data: data.yList // 数值列表
        }]
      }
      // 使用刚指定的配置项和数据显示图表。
